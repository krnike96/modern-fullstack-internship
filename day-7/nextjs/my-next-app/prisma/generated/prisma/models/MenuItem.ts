...
export type MenuItemWhereInput = {
  ...
  item_id?: Prisma.IntFilter<"MenuItem"> | number
  item_name?: Prisma.StringFilter<"MenuItem"> | string
...
export type MenuItemScalarWhereWithAggregatesInput = {
  ...
  item_id?: Prisma.IntWithAggregatesFilter<"MenuItem"> | number
  item_name?: Prisma.StringWithAggregatesFilter<"MenuItem"> | string
...
export type MenuItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"item_id" | "item_name" | "price" | "category", ExtArgs["result"]["menuItem"]>
...
export interface MenuItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const menuItemWithItem_idOnly = await prisma.menuItem.findMany({ select: { item_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many MenuItems and only return the `item_id`
   * const menuItemWithItem_idOnly = await prisma.menuItem.createManyAndReturn({
   *   select: { item_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more MenuItems and only return the `item_id`
   * const menuItemWithItem_idOnly = await prisma.menuItem.updateManyAndReturn({
   *   select: { item_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface MenuItemFieldRefs {
  readonly item_id: Prisma.FieldRef<"MenuItem", 'Int'>
  readonly item_name: Prisma.FieldRef<"MenuItem", 'String'>
